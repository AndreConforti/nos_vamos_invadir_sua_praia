...
#
#    exemplo.nome = ''
#    assert exemplo.verifica_nome() == False # Verifica se não é vazio
#
#    exemplo.nome = 'Andre123'
#    assert exemplo.verifica_nome() == False # Verifica se possui números
#
#    exemplo.nome = 'Ricardo Martins' 
#    assert exemplo.verifica_nome() == True # Verifica se está correto
#
#
